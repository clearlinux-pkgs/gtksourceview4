...
License  : LGPL-2.1
Requires: gtksourceview4-data = %{version}-%{release}
Requires: gtksourceview4-lib = %{version}-%{release}
Requires: gtksourceview4-license = %{version}-%{release}
Requires: gtksourceview4-locales = %{version}-%{release}
...
%package data
Summary: data components for the gtksourceview4 package.
Group: Data

%description data
data components for the gtksourceview4 package.


%package dev
Summary: dev components for the gtksourceview4 package.
Group: Development
Requires: gtksourceview4-lib = %{version}-%{release}
Requires: gtksourceview4-data = %{version}-%{release}
Provides: gtksourceview4-devel = %{version}-%{release}
Requires: gtksourceview4 = %{version}-%{release}

%description dev
dev components for the gtksourceview4 package.


%package lib
Summary: lib components for the gtksourceview4 package.
Group: Libraries
Requires: gtksourceview4-data = %{version}-%{release}
Requires: gtksourceview4-license = %{version}-%{release}

%description lib
lib components for the gtksourceview4 package.


%package license
Summary: license components for the gtksourceview4 package.
Group: Default

%description license
license components for the gtksourceview4 package.


%package locales
Summary: locales components for the gtksourceview4 package.
Group: Default

%description locales
locales components for the gtksourceview4 package.


%prep
%setup -q -n gtksourceview-4.8.4
cd %{_builddir}/gtksourceview-4.8.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667506813
...
/usr/share/package-licenses/gtksourceview4/caeb68c46fa36651acf592771d09de7937926bb3
